        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 offset-lg-1" style="margin-top: 150px;text-align: center;">
                    ...
                    <p>
                       Discover our wide range of digital marketing services and tailored solutions for your business growth. ​
                    </p>
                </div>
                <div class="col-lg-7 mb-40">
                    <img src="{{asset('frontend/assets/images/services/9027293 1 2.png')}}" class="img-fluid" alt="Business Man with Laptop" width="389" height="391">
                </div>
            </div>
        </div>
    </section>
